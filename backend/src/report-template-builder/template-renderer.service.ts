    ...
    if (sigBlock && !html.includes('{{digital_signature}}')) {
      if (html.includes('class="cert-page"')) {
        ...
        // so it never spills onto a second PDF page.
          const footer = `<div class="certificate-authenticity" style="position:absolute;left:50%;transform:translateX(-50%);bottom:145px;width:620px;max-height:72px;overflow:visible;z-index:50;background:rgba(255,255,255,0.96);"><style>.certificate-authenticity>div{margin-top:0!important;gap:8px!important;line-height:1!important}.certificate-authenticity>div>div{min-width:0!important;padding:0 3px!important}.certificate-authenticity *{font-size:8px!important;line-height:1.1!important;margin-top:0!important;margin-bottom:0!important;padding-top:0!important;padding-bottom:0!important}.certificate-authenticity>div>div>div:first-child{font-size:8px!important}.certificate-authenticity>div>div>div:nth-child(2){font-size:10px!important;margin:1px 0!important}.certificate-authenticity>div>div>div:nth-child(3){font-size:8px!important}</style>${sigBlock}</div>`;
         html = html.includes('<div class="cert-page">')
           ? html.replace('<div class="cert-page">', `<div class="cert-page">${footer}`)
           : html.includes('</body>')
