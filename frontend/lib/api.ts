...
export const teacherAnalyticsApi = {
  ...
  getAvailableTeachers: (opts?: { termId?: string }) => api.get('/teacher-analytics/available-teachers', { params: opts }),
  getTeacherOverview: (teacherId: string, opts?: { termId?: string }) => api.get(`/teacher-analytics/teacher/${teacherId}`, { params: opts }),
