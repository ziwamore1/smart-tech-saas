    ...
    return (
      <div style={{ 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
          <div style={{ width: '48px', height: '48px', background: gradOrange, borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 'bold', fontSize: '18px' }}>
            ST
          </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(480px, 1fr))', gap: '24px', maxWidth: '1000px' }}>
        ...
        <div style={{ background: '#fefcf9', borderRadius: '16px', padding: '28px', border: '1px solid #e8ddd0', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
            <div style={{ width: '48px', height: '48px', background: gradOrange, borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 600, fontSize: '18px' }}>
          ...
          <button
            ...
            disabled={saving}
            style={{
              padding: '12px 28px', background: saving ? '#9ca3af' : gradOrange, color: 'white',
        ...
        <div style={{ background: '#fefcf9', borderRadius: '16px', padding: '28px', border: '1px solid #e8ddd0', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
          ...
          <button
            ...
            disabled={saving || !password.currentPassword || !password.newPassword || !password.confirmPassword}
            style={{
              padding: '12px 28px',
              background: (saving || !password.currentPassword || !password.newPassword || !password.confirmPassword) ? '#9ca3af' : 'linear-gradient(135deg, #6366f1, #4f46e5)',
              color: 'white', border: 'none', borderRadius: '10px', fontWeight: 600, fontSize: '14px',
              cursor: (saving || !password.currentPassword || !password.newPassword || !password.confirmPassword) ? 'not-allowed' : 'pointer',
              transition: 'all 0.2s',
            }}
            onMouseEnter={e => { if (!saving && password.currentPassword && password.newPassword && password.confirmPassword) e.currentTarget.style.opacity = '0.9'; }}
            onMouseLeave={e => e.currentTarget.style.opacity = '1'}
          >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 16px', background: '#f5efe8', borderRadius: '10px' }}>
              ...
              <span style={{ fontSize: '13px', color: '#1f2937', fontWeight: 600 }}>
                <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', padding: '4px 10px', background: '#fef3c7', borderRadius: '9999px', fontSize: '12px', color: '#92400e' }}>
                  <i className="fa fa-shield-alt" style={{ fontSize: '10px' }}></i> Super Admin
                </span>
              </span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 16px', background: '#f5efe8', borderRadius: '10px' }}>
